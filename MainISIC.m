...
dlg_title = 'Input';
num_lines = 1;
defaultans = {'no','yes', '1/5', '1/5', '1/4', '1/20', '1/12', '1/100', '0.9', '40', '1/5', '1/5', '9', '5', '4', '500', '50'};
...
parfor i=2:size(MelList, 2)
    ...
    try
        [MelanomaVectors(i, :), Images(i)] = ExtractFeatures( im, DermLogo, TrimCorners, SampleWidthR, SampleHeightR, ...
...
parfor i=2:size(NotMelList, 2)
    ...
    try
        [NotMelVectors(i, :), Images(i)] = ExtractFeatures( im, DermLogo, TrimCorners, SampleWidthR, SampleHeightR, ...
        SkinWidthR, SkinHeightR, BlobCutOff, ShapeFactor, UnWrapDepth, RoughVal, TextureSampleSizeR, TextureSampleSizeC, ...
        TextureEntropyNeighborhood, ColorClusterSize, NumberToTake, GradientVarLength, EntropyFiltSize);
    catch ME
        msgText = getReport(ME)
