function [ ErrorX, ErrorY ] = GraySymmetryError( Im, mask)
%GraySymmetryError This function takes a gray image, Im, and calculates the
%square error of the pixels along the axes X and Y. IM should already be 
%cutout. Mask is the mask of the object in question.
